            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'title' => esc_html__('Secondary theme color', 'incubator'),
                        'default' => '#fff',
                        'validate' => 'color'
                    ),
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id' => 'tek-modal-formid',
                        'type' => 'text',
                        'title' => esc_html__('Contact Form ID', 'incubator'),
                        'required' => array('tek-header-button-action','equals','1'),
                        'default' => '323'
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'default' => 'Copyright 2017 - Incubator by KeyDesign. All rights reserved.'
                    ),
                    array(
                        'id' => 'tek-social-icons',
                        'type' => 'checkbox',
